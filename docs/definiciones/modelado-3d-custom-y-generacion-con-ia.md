...
- **Export `.bbmodel`**: `exportBlockbench.ts` serializa geometría + jerarquía (`outliner` anidado) + texturas + el array `animations` en el formato que Blockbench/FreeMinecraftModels esperan.
